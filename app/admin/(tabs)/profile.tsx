      ...
      <View className="px-5 md:px-12 my-6 md:my-10  space-y-6  ">
        <View className="bg-originblue rounded-3xl  p-5 md:px-16">
          <View className="items-center">
            ...
            />
            <ThemedText className="text-xl md:text-3xl mt-5 font-oextrabold text-white uppercase" numberOfLines={1}>
              {data.name}
            </ThemedText>
        ...
        <Link href="/admin/profile-settings" asChild>
          <TouchableOpacity>
            <View
              className="flex-row  items-center shadow-sm shadow-grey  px-2 md:px-6 py-1.5 md:py-4"
              style={[
                {
