...
export default function RootLayout() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="pilih-driver" options={{ title: 'Pilih Driver', headerTintColor: '#000000', headerStyle: { backgroundColor: 'transparent' } }} />
      <Stack.Screen name="pilih-installer" options={{ title: 'Pilih Installer', headerTintColor: '#000000', headerStyle: { backgroundColor: 'transparent' } }} />
