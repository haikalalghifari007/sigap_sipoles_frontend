...
export default function DetailOrderUnprocessed() {
                    ...
                    <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.scrollContent}>
                        <View style={styles.informationContainer}>
                            ...
                            <View style={styles.selectionContainer}>
                                <TouchableOpacity style={styles.selectionRow} onPress={() => router.push('/vendor/pilih-driver')} >
                                    <Image source={require('../../assets/images/psname.png')} style={styles.avatarIcon} />
                                ...
                                <TouchableOpacity style={styles.selectionRow} onPress={() => router.push('/vendor/pilih-installer')} >
                                    <Image source={require('../../assets/images/psname.png')} style={styles.avatarIcon} />
                                    <View style={styles.selectionTextContainer}>
